...
def execute():
    ...
    argparser = argparse.ArgumentParser(
        prog='dirsync.py',
        description='A Python tool to maintain an up-to-date local replica of a directory.'
    )

    argparser.add_argument(
        'src_dir',
        help='source directory to be synced',
        type=str
    )

    argparser.add_argument(
        'dest_dir',
        help='destination/replica directory',
        type=str
    )

    argparser.add_argument(
        'logfile_path',
        help='path where the src_dir changelog will be written',
        type=str
    )
